...
export default {
    ...
    async mounted(){
       ...
       await axios.get(`http://localhost:3000/${username}`).then(resp => {
        ...
        /*this.ChartList= [
            {
                id: 1,
                yLabel:['data1', 10, 20 , 30 , 40 ,50],
                type: 'line'
            },
            {
                id:2,
                yLabel:['data1', 20, 30 , 10 , 240 ,50],
                type: 'bar'
            },
            {
                id:3,
                yLabel:['data1', 56, 23 , 45 , 40 ,50],
                type: 'step'
            },
            {
                id:4,
                yLabel:['data1', 5, 60 , 30 , 47 ,50],
                type: 'line'
            },
            {
                id:5,
                yLabel:['data1', 63, 72 , 36 , 27 ,50],
                type: 'bar'
            }
